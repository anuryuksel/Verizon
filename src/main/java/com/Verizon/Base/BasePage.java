...
public class BasePage  {
	...
	// I use properties in order to store the configurable parameters of an application or project. 
	/** 
	...
	public Properties initialize_properties(){
	 ...
	 try{
	 FileInputStream ip = new FileInputStream("/Users/anur/Documents/workspace/AnurYuksel_VerizonTest/"
